            ...
            <div className="container mt-5">
                <form onSubmit={e => {submit_handlinator(e)}}>
                    <div className="mb-3">
                        ...
                        <input type="email" className="form-control" id="email" aria-describedby="emailHelp" onChange={e => {setUser({ ...user, "email": e.target.value })}}/>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="password" className="form-control" id="password2" onChange={e => {setConfirmPassword(e.target.value)}}/>
                    </div>
